...
export class SalesService {
  ...
  /**
   * Obtiene el reporte de ventas diario agrupado por tipo de pago.
   */
  async getDailyReport(date: string) {
    ...
    // Usamos el inicio y fin del día en UTC
    ...
    if (error) {
      ...
      throw new InternalServerErrorException(`Error al generar reporte: ${error.message}`);
    }
